"""Sidecar STT do Speecher: servidor HTTP local com faster-whisper residente na GPU.
...
def _watch_parent():
    ...
    ppid = int(os.environ.get("SPEECHER_PARENT_PID", "0"))
    if not ppid:
        return
...
PORT = int(os.environ.get("SPEECHER_STT_PORT", "17765"))
