...
const TABS = ["Geral", "Perfis", "Dicionário", "Snippets", "Histórico", "Diagnóstico"] as const;
  ...
  return (
    <section>
      ...
      <p className="hint">
        ...
        maiúsculas. Ex.: Maria Fernandes, Wispr Flow.
      </p>
...
function SnippetsTab({ s, patch }: TabProps) {
  ...
  return (
    <section>
      <h1>Snippets</h1>
      <p className="hint">
        Diga o gatilho durante o ditado e ele vira o texto completo. Ex.: "meu e-mail" →
